param(
    ...
    [string]$OutputFile = "missions/missions-06/results/docker-stats.csv",
    [string]$SummaryFile = ""
)

$containers = @(
    "shortener-nginx-mission-06"
    "shortener-app1-mission-06"
    "shortener-app2-mission-06"
    "shortener-app3-mission-06"
    "shortener-redis-mission-06"
    "shortener-db-mission-06"
)
