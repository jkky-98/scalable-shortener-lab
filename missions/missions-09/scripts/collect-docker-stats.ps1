param(
    ...
    [string]$OutputFile = "missions/missions-09/results/docker-stats.csv",
    [string]$SummaryFile = ""
)

$containers = @(
    "shortener-nginx-mission-09"
    "shortener-app1-mission-09"
    "shortener-app2-mission-09"
    "shortener-app3-mission-09"
    "shortener-redis-mission-09"
    "shortener-db-primary-mission-09"
    "shortener-db-replica-mission-09"
)
