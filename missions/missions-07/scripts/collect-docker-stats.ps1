param(
    ...
    [string]$OutputFile = "missions/missions-07/results/docker-stats.csv",
    [string]$SummaryFile = ""
)

$containers = @(
    "shortener-nginx-mission-07"
    "shortener-app1-mission-07"
    "shortener-app2-mission-07"
    "shortener-app3-mission-07"
    "shortener-redis-mission-07"
    "shortener-db-mission-07"
)
